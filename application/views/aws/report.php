		...
		<div class="col">
			<div class="card shadow mb-3">
				...
				<div class="row ">
					<div class="col">
						<div class="card-body">
							<form method="POST" action=" <?= base_url('aws/report'); ?>">
								<div class="row">
									<div class="col-8">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<div class="table-responsive">
				<table class="table table-bordered " id="report_aws" cellspacing="0">
					<thead>
						<tr>
							<th>No</th>
							<th>Tanggal&nbsp;&nbsp;&nbsp;&nbsp;</th>
					...
					<tbody>
						<?php $i = 1; ?>
						<?php if (!empty($dataaws)) {
							foreach ($dataaws as $da) :   ?>
								<tr>
									<th scope="row"><?= $i; ?></th>
									<td><?= $da['tanggal'] ?></td>
									<td><?= $da['time'] ?></td>
...
<script src="<?= base_url(); ?>assets/js/report_aws.js"></script>

...
class Spas_model extends CI_Model
{
	...
	public function getDataTables()
	{
		...
		$id_user = $this->session->userdata('id_user');
		$this->datatables->select('a.id as id, DATE(a.date) as tanggal,TIME(a.date) as time, curah_hujan, tinggi_muka_air, kecepatan_air');
		$this->datatables->from('data_spas a, user c, user_access_data b');
